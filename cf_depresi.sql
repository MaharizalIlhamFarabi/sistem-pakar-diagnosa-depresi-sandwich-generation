...
-- ===== CF pakar per gejala (Opsi A: metode per-gejala) =====
-- Nilai bobot dari tabel pakar skripsi (Tabel 3.3 / 3.4 / 3.5).
ALTER TABLE `gejala` ADD COLUMN IF NOT EXISTS `cf_pakar` DECIMAL(3,2) NOT NULL DEFAULT 0.80;
UPDATE `gejala` SET `cf_pakar` = CASE `kd_gejala`
  WHEN 'G01' THEN 0.80 WHEN 'G02' THEN 0.70 WHEN 'G03' THEN 0.60
  WHEN 'G04' THEN 0.55 WHEN 'G05' THEN 0.80 WHEN 'G06' THEN 0.70 WHEN 'G07' THEN 0.70 WHEN 'G08' THEN 0.80
  WHEN 'G09' THEN 0.50 WHEN 'G10' THEN 0.75 WHEN 'G11' THEN 0.80 WHEN 'G12' THEN 1.00 WHEN 'G13' THEN 0.80 WHEN 'G14' THEN 0.80
  ELSE `cf_pakar` END;
