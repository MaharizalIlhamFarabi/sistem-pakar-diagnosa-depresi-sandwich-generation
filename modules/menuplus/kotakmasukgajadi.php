...
if (isset($_POST["balas"])) {
    ...
    $query = "INSERT INTO pesan (id_admin, id_member, id_balas, pesan, status, waktu) VALUES (?, ?, ?, ?, 'notyet', NOW())";
    
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("ssss", $_POST["id_admin"], $id_member, $_POST["id_balas"], $pesan);
...
$sqlpeb = $mysqli->query("select * from balas_pesan where id_member='$rm[id_member]' order by status asc");
?>
