        ...
        if ($tgl <= $maxdate) {
            ...
            if ($sqlm) {
                echo "<div align='center' class='alert alert-success'>
                        <strong>Berhasil, silakan Login!</strong>
                    </div>";
            ...
            echo "<div align='center' class='alert alert-danger'>
                    <strong>Tanggal Input tidak valid!</strong>
                </div>";
            echo "<META HTTP-EQUIV='Refresh' Content='1; URL=?r=registeruser'>";
        }
    } else {
        echo "<div align='center' class='alert alert-danger'>
                <strong>Silakan Isi Semua Data!</strong>
            </div>";
    }
...
<div id="viewregister">
    <fieldset>
        <form name="form1" method="post" action="" enctype="multipart/form-data">
            <h3 align="center" class="panel panel-info panel-title panel-heading ">HALAMAN REGISTRASI</h3>
            ...
            <p><label>Tanggal Lahir</label><br>
                <select name="tgl" size="1" class="selecttgl">
                    <?php
                    for ($i = 1; $i <= 31; $i++) {
                        $j_disp = str_pad($i, 2, '0', STR_PAD_LEFT);
                        echo "<option value='$j_disp'>$j_disp</option>";
                    }
                    ?>
                </select>
